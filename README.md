...
## 1️⃣ 프로젝트 개요
- **도서 추천 서비스 :** 도서 소개 문장을 입력받아 MBTI 16가지 성향 점수를 예측하고, 이를 바탕으로 사용자와 유사한 성향의 책을 추천하는 MLP 기반 추천 시스템입니다.
...
## 5️⃣ 구현 사진
### 도서 추천 서비스
![도서추천_구현사진_1](Readme_image/도서추천_구현사진_1.png)
- 사용자는 몇 가지 간단한 질문에 응답함으로써 자신의 독서 성향이나 관심사를 반영한 설문조사를 진행할 수 있습니다. 이를 통해 개인의 성격, 관심 분야, 독서 습관 등의 특성을 분석할 수 있습니다.

![도서추천_구현사진_2](Readme_image/도서추천_구현사진_2.png)
- 설문조사 결과를 바탕으로 사용자의 성향을 유형별로 분류할 수 있으며, 어떤 독서 성향 유형에 속하는지를 파악할 수 있습니다. 이를 통해 사용자는 자신의 독서 스타일이나 취향에 대해 이해할 수 있습니다.

![도서추천_구현사진_3](Readme_image/도서추천_구현사진_3.png)
- 분석된 성향 유형을 기반으로, 사용자에게 가장 잘 어울리는 도서 5권을 추천합니다. 각 도서에는 제목, 저자, 간단한 줄거리 등 기본적인 정보가 함께 제공되어, 사용자가 보다 쉽게 관심 있는 책을 선택할 수 있도록 도와줍니다.

<br>

### 챗봇
![챗봇_구현사진_1](Readme_image/챗봇_구현사진_1.png)
![챗봇_구현사진_2](Readme_image/챗봇_구현사진_2.png)
- 사용자가 질문을 하면, 그에 적절한 맞춤형 답변을 제공받을 수 있습니다. 이는 입력 내용을 기반으로 하여, 상황에 맞는 정보나 추천, 설명 등을 즉시 확인할 수 있도록 구성되어 있습니다.
